...
namespace Hope.ITMS.Web
{
    ...
    /// 管理界面首页
    /// </summary>
    public class Home_Index : BaseManageActionResult
    {
        ...
        public Home_Index(ManageController controller): base(controller)
        {
        }
    ...
    /// 管理界面首页
    /// </summary>
    public class Home_Main : BaseManageActionResult
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="controller"></param>
        public Home_Main(ManageController controller)
            : base(controller)
        {
        }
