...
function SelectDate(obj, strFormat, x, y) {
    ...
    var date = new Date();
    var by = date.getFullYear() - 15; //最小值 → 15 年前
    var ey = date.getFullYear() + 15; //最大值 → 15 年后
...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
    ...
    this.colors = {
        "cur_word": "#000", //当日日期文字颜色
        "cur_bg": "#fff", //当日日期单元格背影色
        "sel_bg": "#73d9ff", //已被选择的日期单元格背影色 2006-12-03 寒羽枫添加
        "sun_word": "#c95720", //星期天文字颜色
        "sat_word": "#c95720", //星期六文字颜色
        "td_word_light": "#333333", //单元格文字颜色
        "td_word_dark": "#CCCCCC", //单元格文字暗色
        "td_bg_out": "#f8f8f8", //单元格背影色
        "td_bg_over": "#73d9ff", //单元格背影色
        "tr_word": "#000", //日历头文字颜色
        "tr_bg": "#ddd", //日历头背影色
        "input_border": "#42a3d0", //input控件的边框颜色
        "input_bg": "#42a3d0" //input控件的背影色
    }
...
Calendar.prototype.draw = function() {
    ...
    mvAry[mvAry.length] = ' <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px;background-color:' + calendar.colors["input_bg"] + ';">';
    mvAry[mvAry.length] = ' <tr>';
    mvAry[mvAry.length] = ' <th align="center" width="1%"><input style="color:#fff;font-weight:bold;border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';height:22px;';
    ...
    mvAry[mvAry.length] = ' <input name="calendarClear" type="button" id="calendarClear" value="' + Calendar.language["clear"][this.lang] + '" style="color:#fff;border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:40px;height:20px;font-size:12px;cursor:pointer;"/>';
    ...
    mvAry[mvAry.length] = '" style="color:#fff;border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:60px;height:20px;font-size:12px;cursor:pointer"/>';
    mvAry[mvAry.length] = ' <input name="calendarClose" type="button" id="calendarClose" value="' + Calendar.language["close"][this.lang] + '" style="color:#fff;border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:40px;height:20px;font-size:12px;cursor:pointer"/>';
