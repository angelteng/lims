 ...
 * 类 名 称：CommonFieldBLL(CommonFieldBLL)
 * 功能描述：
 * 
 * ------------创建信息------------------
 * 作    者：jjf001
...
{
    /// <summary>
    /// BusinessHandler CommonFieldBLL
    /// </summary>
    public class CommonFieldBLL:BaseBLL
    {
		//申明DAL接口
		private CommonFieldDAL Provider = DALFactory.Instance().CommonFieldDAL;
		
		#region constructor
        /// <summary>
        /// CommonFieldBLL
        /// </summary>
        public CommonFieldBLL()
        {
        }
		#endregion
        ...
        public SystemMessage Add(CommonField entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns>return the handler result</returns>
        public SystemMessage Edit(CommonField entity)
        { 
			CommonField originEntity = Provider.GetData(entity.Name);
        ...
        ///<param name="id"></param>
        /// <returns></returns>
        public CommonField GetData(int id)
        {           
			try
			{
        ...
        /// </summary>
        /// <returns></returns>
        public List<CommonField> GetList()
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonField> GetList(int modelId)
        {
            try
            {
                return Provider.GetDatasByProperty("ModelID", modelId);
            }
            catch (Exception ex)
            {
                // 将错误日志写入数据库
        ...
        /// <returns></returns>
        public List<CommonField> GetList(List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonField> GetList(PagerData pager)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<CommonField> GetList(PagerData pager,List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonField> GetList(PagerData pager,OrderItem order)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonField> GetList(PagerData pager,OrderItemCollection orders)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<CommonField> GetList(PagerData pager,OrderItemCollection orders,List<SimpleExpression> exps)
        {
			try
			{
