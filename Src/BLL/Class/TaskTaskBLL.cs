...
{
    /// <summary>
    /// BusinessHandler TaskTaskBLL
    /// </summary>
    public class TaskTaskBLL:BaseBLL
    {
		//申明DAL接口
		private TaskTaskDAL Provider = DALFactory.Instance().TaskTaskDAL;
        ...
        public SystemMessage Add(TaskTask entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns>return the handler result</returns>
        public SystemMessage Edit(TaskTask entity)
        { 
			TaskTask originEntity = Provider.GetData(entity.Name);
        ...
        ///<param name="id"></param>
        /// <returns></returns>
        public TaskTask GetData(int id)
        {           
			try
			{
        ...
        /// <returns></returns>
        public List<TaskTask> GetList(List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<TaskTask> GetList(PagerData pager)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<TaskTask> GetList(PagerData pager,List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<TaskTask> GetList(PagerData pager,OrderItem order)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<TaskTask> GetList(PagerData pager,OrderItemCollection orders)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<TaskTask> GetList(PagerData pager,OrderItemCollection orders,List<SimpleExpression> exps)
        {
			try
			{
