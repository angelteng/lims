 ...
 * 类 名 称：DevDeviceBLL(DevDeviceBLL)
 * 功能描述：
 * 
 * ------------创建信息------------------
 * 作    者：jjf001
...
{
    /// <summary>
    /// BusinessHandler DevDeviceBLL
    /// </summary>
    public class DevDeviceBLL:BaseBLL
    {
		//申明DAL接口
		private DevDeviceDAL Provider = DALFactory.Instance().DevDeviceDAL;
        ...
        public SystemMessage Add(DevDevice entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns>return the handler result</returns>
        public SystemMessage Edit(DevDevice entity)
        { 
			DevDevice originEntity = Provider.GetData(entity.Name);
        ...
        ///<param name="id"></param>
        /// <returns></returns>
        public DevDevice GetData(int id)
        {           
			try
			{
        ...
        /// <returns></returns>
        public List<DevDevice> GetList(List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<DevDevice> GetList(PagerData pager)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<DevDevice> GetList(PagerData pager,List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<DevDevice> GetList(PagerData pager,OrderItem order)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<DevDevice> GetList(PagerData pager,OrderItemCollection orders)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<DevDevice> GetList(PagerData pager,OrderItemCollection orders,List<SimpleExpression> exps)
        {
			try
			{
