...
{
    /// <summary>
    /// BusinessHandler OrgGroupBLL
    /// </summary>
    public class OrgGroupBLL:BaseBLL
    {
		//申明DAL接口
		private OrgGroupDAL Provider = DALFactory.Instance().OrgGroupDAL;
        ...
        public SystemMessage Add(OrgGroup entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns>return the handler result</returns>
        public SystemMessage Edit(OrgGroup entity)
        { 
			OrgGroup originEntity = Provider.GetData(entity.Name);
        ...
        ///<param name="id"></param>
        /// <returns></returns>
        public OrgGroup GetData(int id)
        {           
			try
			{
        ...
        /// <returns></returns>
        public List<OrgGroup> GetList(List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<OrgGroup> GetList(PagerData pager)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<OrgGroup> GetList(PagerData pager,List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<OrgGroup> GetList(PagerData pager,OrderItem order)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<OrgGroup> GetList(PagerData pager,OrderItemCollection orders)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<OrgGroup> GetList(PagerData pager,OrderItemCollection orders,List<SimpleExpression> exps)
        {
			try
			{
