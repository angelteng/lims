 ...
 * 类 名 称：CommonModelBLL(CommonModelBLL)
 * 功能描述：
 * 
 * ------------创建信息------------------
 * 作    者：jjf001
...
{
    /// <summary>
    /// BusinessHandler CommonModelBLL
    /// </summary>
    public class CommonModelBLL:BaseBLL
    {
		//申明DAL接口
		private CommonModelDAL Provider = DALFactory.Instance().CommonModelDAL;
		
		#region constructor
        /// <summary>
        /// CommonModelBLL
        /// </summary>
        public CommonModelBLL()
        {
        }
		#endregion
        ...
        public SystemMessage Add(CommonModel entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns>return the handler result</returns>
        public SystemMessage Edit(CommonModel entity)
        { 
			CommonModel originEntity = Provider.GetData(entity.Name);
        ...
        ///<param name="id"></param>
        /// <returns></returns>
        public CommonModel GetData(int id)
        {           
			try
			{
        ...
        /// <returns></returns>
        public List<CommonModel> GetList(List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonModel> GetList(PagerData pager)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<CommonModel> GetList(PagerData pager,List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonModel> GetList(PagerData pager,OrderItem order)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<CommonModel> GetList(PagerData pager,OrderItemCollection orders)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<CommonModel> GetList(PagerData pager,OrderItemCollection orders,List<SimpleExpression> exps)
        {
			try
			{
