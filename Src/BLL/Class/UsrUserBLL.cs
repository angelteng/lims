...
{
    /// <summary>
    /// BusinessHandler UsrUserBLL
    /// </summary>
    public class UsrUserBLL:BaseBLL
    {
		//申明DAL接口
		private UsrUserDAL Provider = DALFactory.Instance().UsrUserDAL;
        ...
        public SystemMessage Add(UsrUser entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns>return the handler result</returns>
        public SystemMessage Edit(UsrUser entity)
        { 
			UsrUser originEntity = Provider.GetData(entity.Name);
        ...
        /// <returns></returns>
        public List<UsrUser> GetList(List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<UsrUser> GetList(PagerData pager)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<UsrUser> GetList(PagerData pager,List<SimpleExpression> exps)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<UsrUser> GetList(PagerData pager,OrderItem order)
        {
			try
			{
        ...
        /// <returns></returns>
        public List<UsrUser> GetList(PagerData pager,OrderItemCollection orders)
        {
			try
			{
		...
		/// <param name="exps">查询条件</param>
        /// <returns></returns>
        public List<UsrUser> GetList(PagerData pager,OrderItemCollection orders,List<SimpleExpression> exps)
        {
			try
			{
